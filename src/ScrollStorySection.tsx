...
const IMAGES = [
  { src: '/solira1.png', leftText: 'The Awakening', rightText: 'A new dawn in luxury.' },
  { src: '/solira2.png', leftText: 'The Journey', rightText: 'Elegance in every step.' },
  { src: '/solira3.png', leftText: 'The Encounter', rightText: 'Where art meets fashion.' },
  { src: '/solira4.png', leftText: 'The Arrival', rightText: 'Solira, revealed.' },
];
